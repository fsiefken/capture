;(function (window, document) {
  ...
  pictureButton.addEventListener("click", function (e) {
        ...
        if (canvas.getContext) {
             ...
             *
             */
            dlImage = canvas.toDataURL("image/jpeg", 0.1);
            dlPhoto.setAttribute("href", dlImage);
            dlPhoto.setAttribute("download", "image.jpg");

            dlPhoto.innerHTML = "Upload";
  ...
  doc.addEventListener("loadedmetadata", function () {
    window.setTimeout(function () {
      dimension.innerHTML = "videoWidth/Height: " + video.videoWidth + "x" + video.videoHeight + "px.";
    }, 3700);
  }, true); 
    */
